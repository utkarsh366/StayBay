  ...
  return (
    <div  className="shadow-lg p-3 mb-5 bg-body rounded"  >
      ...
      />
        ...
        <p className="text-end" style={{marginTop:"-40px"}}>₹{hostel.price} per month</p>
        <p className="text-start">Location:{hostel.location}</p>
        </div>
        <div className="d-grid gap-2">
        <Link to={`/hostel/${hostel._id}`} className="btn btn-info" style={{background:"#330033",color:"#fff"}}> Check  Details </Link>
        </div>
