...
const Sidebar = () => {
    ...
    return (
        <div>
            <div className="card price_filter" style={{width:"190px"}}>
            ...
            <div className="price_filter" style={{background:"#fff",borderRadius:"6px"}}>
            <p className="text-start text-bold" style={{background:"#fff"}}>Filter By Star</p>
